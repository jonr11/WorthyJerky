...
<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post" >
			<ul class="nav">
				...
				<li class="nav">
						...
						">
						<input type="image" class="cart" src="images/sc3" border="0" width="20" height="20" name="submit" alt="PayPal - The safer, easier way to pay online!">
				...
				<?php 
		            if (adminLoggedIn()) {
						echo "<li class='nav'><a href='login.php' class='admin'>ADMIN MODE</a></li>";
					} 
				?>
			</ul>
</form>
